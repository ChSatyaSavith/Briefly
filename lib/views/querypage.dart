...
import 'package:practice/views/categorypage.dart';
...
class QPage extends StatefulWidget {
  ...
  const QPage({super.key, required this.category});
...
class _QPageState extends State<QPage> {
  ...
  getNews() async {
    CategoryNews_q newsdata = CategoryNews_q();
    await newsdata.getNews_q(widget.category);
